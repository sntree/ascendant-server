...
struct StatBonuses {
	...
	int32	GiveDoubleRiposte[5];				// 0=Regular Chance, 1=Skill Attack Chance, 2=Skill, 3=Skill Attack Chance2, 4=Skill2
...
namespace SBIndex {
	...
	constexpr uint16 DOUBLE_RIPOSTE_SKILL_ATK_CHANCE2       = 3; // SPA 223 — second slot for cross-class stacking
	constexpr uint16 DOUBLE_RIPOSTE_SKILL2                  = 4; // SPA 223
